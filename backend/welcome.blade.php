...
<div class="size1 overlay1">
    ...
    <div class="size1 flex-col-c-m p-l-15 p-r-15 p-t-50 p-b-50">
        ...
        <form class="w-full flex-w flex-c-m validate-form" action="{{route('emails')}}">
            ...
            <input class="input100 placeholder0 s2-txt2" type="hidden" name="uri" value={{(string) url()->current()}} >
